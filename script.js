...
const ownInitials = ["묭", "밍", "뜬", "츄", "녛", "쭌", "셈"];
 ...
 * 이니셜(묭·민·뜬·츄·녛·쭌·셈)을 그대로 이어붙인 기본값이니,
 * 원하는 조합명으로 자유롭게 바꿔서 쓰시면 돼요.
 */
const pairNames = [
    ["묭묭", "묭민", "묭커", "묭츄", "묭녛", "묭혁", "묭셈"],
    ["민묭", "밍밍", "밍뜬", "밍츄", "민녛", "밍쭌", "밍셈"],
    ["뜬묭", "뜬밍", "뜬뜬", "뜬츄", "뜬냥", "뜬쭌", "뜬셈"],
    ["츄묭", "츄밍", "츄뜬", "츄츄", "츄녛", "츄쭌", "츄셈"],
    ["녛묭", "녛민", "녛뜬", "녛츄", "녛녛", "성녁", "녛셈"],
    ["혁묭", "쭌밍", "쭌뜬", "쭌츄", "녁성", "쭌쭌", "쭌셈"],
    ["셈묭", "셈밍", "셈뜬", "셈츄", "셈녛", "셈쭌", "셈셈"]
];
...
const STORAGE_KEY = "idid-ditpes-rps";
...
saveBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        const fileLabel = currentTab === "rps" ? "딧페스_취향표" : "공수_취향표";
